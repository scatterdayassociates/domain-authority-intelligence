...
const executions: Execution[] = [
  { id: "EX-0329-001", pack: "Dell — Laptops — US", version: "v3", model: "GPT-4o", prompts: 7, totalRuns: 35, status: "Completed", started: "Apr 3, 2026 9:02 AM", duration: "3m 47s" },
  { id: "EX-0322-002", pack: "Dell — Laptops — US", version: "v2", model: "GPT-4o", prompts: 6, totalRuns: 30, status: "Completed", started: "Mar 29, 2026 2:14 PM", duration: "3m 12s" },
  { id: "EX-0315-003", pack: "Dell — Laptops — US", version: "v1", model: "GPT-4o", prompts: 5, totalRuns: 25, status: "Completed", started: "Mar 22, 2026 10:30 AM", duration: "2m 55s" },
  { id: "EX-0401-004", pack: "Sony — Headphones — UK", version: "v1", model: "Claude 3.5 Sonnet", prompts: 8, totalRuns: 40, status: "Completed", started: "Apr 1, 2026 4:45 PM", duration: "5m 02s" },
  { id: "EX-0328-005", pack: "Sony — Headphones — UK", version: "v1", model: "GPT-4o", prompts: 8, totalRuns: 40, status: "Failed", started: "Mar 28, 2026 11:20 AM", duration: "1m 08s" },
  { id: "EX-0403-006", pack: "Nike — Running — US", version: "v2", model: "GPT-4o", prompts: 10, totalRuns: 50, status: "Running", started: "Apr 3, 2026 9:08 AM", duration: "—" },
  { id: "EX-0403-007", pack: "Nike — Running — US", version: "v2", model: "Claude 3.5 Sonnet", prompts: 10, totalRuns: 50, status: "Queued", started: "Apr 3, 2026 9:08 AM", duration: "—" },
  { id: "EX-0402-008", pack: "Nike — Running — US", version: "v1", model: "GPT-4o", prompts: 9, totalRuns: 45, status: "Completed", started: "Apr 2, 2026 3:30 PM", duration: "6m 11s" },
];
