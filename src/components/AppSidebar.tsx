import { Layers, PlayCircle, Cpu, Calculator, Settings } from "lucide-react";

const modules = [
  { name: "Prompt Manager", icon: Layers, active: true },
  { name: "Execution", icon: PlayCircle, soon: true },
  { name: "Parsing", icon: Cpu, soon: true },
  { name: "Scoring Engine", icon: Calculator, soon: true },
];
