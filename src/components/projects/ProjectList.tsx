const projects = [
  { name: "Dell — Laptops", vertical: "Consumer Electronics", market: "United States", model: "GPT-4o", packVersion: "v3", packStatus: "Active" as const, executions: 3, lastRun: "Apr 3, 2026", inclusionRate: 82, pipelineStatus: "Running" as const },
  { name: "Sony — Headphones", vertical: "Consumer Electronics", market: "United Kingdom", model: "Claude 3.5 Sonnet", packVersion: "v1", packStatus: "Active" as const, executions: 2, lastRun: "Apr 1, 2026", inclusionRate: 64, pipelineStatus: "Scored" as const },
  { name: "Nike — Running", vertical: "Apparel & Footwear", market: "United States", model: "GPT-4o", packVersion: "v2", packStatus: "Active" as const, executions: 2, lastRun: "Apr 3, 2026", inclusionRate: 55, pipelineStatus: "Scored" as const },
  { name: "Samsung — Smartphones", vertical: "Consumer Electronics", market: "Germany", model: "GPT-4o", packVersion: "v1", packStatus: "Draft" as const, executions: 0, lastRun: null, inclusionRate: null, pipelineStatus: "Not Started" as const },
  { name: "Philips — Air Purifiers", vertical: "Home Appliances", market: "France", model: "GPT-4o", packVersion: "v1", packStatus: "Draft" as const, executions: 0, lastRun: null, inclusionRate: null, pipelineStatus: "Not Started" as const },
  { name: "HP — Printers", vertical: "Consumer Electronics", market: "United States", model: "GPT-4o", packVersion: "v2", packStatus: "Active" as const, executions: 1, lastRun: "Mar 15, 2026", inclusionRate: 71, pipelineStatus: "Scored" as const },
];
        ...
        {projects.map((p, i) => (
          ...
          >
            ...
            <td className="px-3 py-2.5">
              <span className="text-sm text-slate-800">{p.packVersion} · </span>
              <span className={`inline-flex items-center gap-1 text-xs ${p.packStatus === "Active" ? "text-green-600" : "text-amber-600"}`}>
                <span className={`w-1.5 h-1.5 rounded-full ${p.packStatus === "Active" ? "bg-green-500" : "bg-amber-500"}`} />
                {p.packStatus}
              </span>
            </td>
