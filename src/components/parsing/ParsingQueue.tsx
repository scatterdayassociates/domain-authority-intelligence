...
const rows = [
  { id: "EX-0329-001", pack: "Dell — Laptops — US", model: "GPT-4o", totalRuns: 35, parsed: 35, failed: 0, domains: 312, status: "Parsed", parsedAt: "Apr 3, 2026 9:06 AM" },
  { id: "EX-0322-002", pack: "Dell — Laptops — US", model: "GPT-4o", totalRuns: 30, parsed: 30, failed: 0, domains: 268, status: "Parsed", parsedAt: "Mar 29, 2026 2:16 PM" },
  { id: "EX-0315-003", pack: "Dell — Laptops — US", model: "GPT-4o", totalRuns: 25, parsed: 25, failed: 0, domains: 210, status: "Parsed", parsedAt: "Mar 22, 2026 10:33 AM" },
  { id: "EX-0401-004", pack: "Sony — Headphones — UK", model: "Claude 3.5 Sonnet", totalRuns: 40, parsed: 37, failed: 3, domains: 344, status: "Partial", parsedAt: "Apr 1, 2026 4:48 PM" },
  { id: "EX-0328-005", pack: "Sony — Headphones — UK", model: "GPT-4o", totalRuns: 40, parsed: 0, failed: 40, domains: 0, status: "Failed", parsedAt: "" },
  { id: "EX-0403-006", pack: "Nike — Running — US", model: "GPT-4o", totalRuns: 50, parsed: 50, failed: 0, domains: 441, status: "Parsed", parsedAt: "Apr 3, 2026 9:18 AM" },
  { id: "EX-0402-008", pack: "Nike — Running — US", model: "GPT-4o", totalRuns: 45, parsed: 44, failed: 1, domains: 396, status: "Partial", parsedAt: "Apr 2, 2026 3:36 PM" },
  { id: "EX-0403-NEW", pack: "Nike — Running — US", model: "Claude 3.5 Sonnet", totalRuns: 50, parsed: null, failed: null, domains: null, status: "Pending", parsedAt: "" },
];
